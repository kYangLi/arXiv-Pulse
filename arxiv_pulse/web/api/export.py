...
def generate_markdown(
    ...
    lines.append(f"\n---\n{i18n['generated_by']} [arXiv Pulse]({GITHUB_URL})\n")
...
def generate_pdf(
    ...
    html_parts.append(f'<div style="text-align: center; margin-top: 20pt; color: #888; font-size: 9pt;">')
    html_parts.append(f'{i18n["generated_by"]} <a href="{GITHUB_URL}" style="color: #c9a227;">arXiv Pulse</a>')
    html_parts.append("</div>")
